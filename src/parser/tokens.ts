 ...
 */
function generateTokensFromList(list: readonly string[]): Map<string, TokenType> {
...
const IDENTIFIER_KEYWORD_NAMES = new globalThis.Set([
  // Data type keywords
  "Symbol", "Timestamp", "Date", "Time", "Int", "Integer", "Long", "Long128",
  "Long256", "Short", "Byte", "Float", "Double", "Boolean", "String", "Char",
  "Binary", "Uuid", "Ipv4", "Geohash", "Varchar", "Decimal", "Interval", "TimestampNs",
  // Common identifier-like keywords
  "Index", "Key", "Column", "Type", "Level", "Offset", "First", "Volume",
  "Start", "Current", "User", "Users", "Public", "Default", "View",
  // Time units (from grammar/constants.ts)
  "Hour", "Day", "Week", "Month", "Year", "Days", "Hours", "Months", "Weeks", "Years",
  "Minute", "Minutes", "Second", "Seconds",
  "Millisecond", "Milliseconds", "Microsecond", "Microseconds",
  "Nanosecond", "Nanoseconds",
  "Century", "Decade", "Millennium", "Quarter",
  "Dow", "Doy", "Epoch", "Isodow", "Isoyear",
  // Function name keywords
  "Replace", "Tables", "Format", "Header", "Query", "Enable", "Disable",
  "None", "Error", "System", "Http",
  // Entity/config keywords
  "Account", "Accounts", "Service", "Token", "Rest", "Password", "Partition",
  "Partitions", "PartitionBy", "Dedup", "Wal", "Bypass", "Batch", "No", "Groups",
  "Assume", "Database", "Backup", "Foreign", "Primary", "References", "Cascade",
  "Capacity", "Cancel", "Prevailing", "Writer", "Materialized", "Range", "Snapshot",
  "Unlock", "Refresh",
  // ALTER TABLE sub-operations
  "Add", "Attach", "Detach", "Convert", "Remove", "Squash", "Suspend", "Resume", "Release",
  // COPY/export parameters
  "Parquet", "ParquetVersion", "Abort", "Alias", "Base", "Complete",
  "CompressionCodec", "CompressionLevel", "DataPageSize", "Delimiter", "Exit",
  "Ignore", "Option", "Param", "Prepare", "RowGroupSize", "SkipRow", "SkipColumn",
  "Verification",
  // CREATE TABLE / DDL config
  "Atomic", "CommitLag", "Delay", "External", "Incremental", "MaxUncommittedRows",
  "O3MaxLag", "Ttl", "Deferred",
  // SHOW sub-keywords
  "Columns", "Keys", "List", "Parameters", "Permissions", "ServerVersion",
  "StatisticsEnabled", "Txn", "Within",
  // Config/metadata
  "Calendar", "Checkpoint", "Cumulative", "Isolation", "Jwk", "Length", "Manual",
  "Nocache", "Observation", "Overridable", "Owned", "Period", "Reindex", "Tolerance",
  "Transaction", "Zone",
  // Compression codecs
  "RawArrayEncoding", "Uncompressed", "Snappy", "Gzip", "Lz4", "Zstd", "Lz4Raw",
  "Brotli", "Lzo",
  // Other non-reserved keywords
  "Compile", "Delete", "Upsert", "Cache", "Exclusive", "Immediate", "Only", "Align", "Latest",
  // New constants that can be used as identifiers
  "Ilp", "Native", "Pgwire",
  // Window frame keywords
  "Row", "Rows", "Preceding", "Following", "Unbounded", "Exclude", "Others", "Nulls",
  // SAMPLE BY keywords
  "Fill", "Every", "Prev", "Linear",
]);
 ...
 */
export const keywordTokenArray: TokenType[] = Array.from(allGeneratedTokens.values());
